...
typedef struct UserCtx {
  ...
  PetscInt *miglist; // list of ranks to migrate to, that can be populated every time a BASIC migration has to be done.
...
PetscInt ISLineTriangleIntp(Cmpnts p1, Cmpnts p2, IBMNodes *ibm, intn_v);
...
void Compute_du_center (PetscInt i, PetscInt j, PetscInt k,  PetscInt mx, PetscInt my, PetscInt mz, Cmpnts ***ucat, PetscReal ***nvert, double *dudc, double *dvdc, double *dwdc, double *dude, double *dvde, double *dwde, double *dudz, double *dvdz, double *dwdz);
void Compute_dscalar_center (PetscInt i, PetscInt j, PetscInt k,  PetscInt mx, PetscInt my, PetscInt mz, PetscReal ***K, PetscReal ***nvert, double *dkdc, double *dkde, double *dkdz);
...
/////////////////////////////////////data
PetscInt pointcell_advanced(Cmpnts p, PetscInt ip, PetscInt jp, PetscInt kp,
